 ...
 */
public class G02 implements GCode {
     ...
     */
    public G02(double[] startPosition, double[] finalPosition,
               double radius, double staticVelocity, double acceleration,
               String gCode) {
        ...
        this.gCode = gCode;
        centerPosition = MathCalc.findCenterG02(startPosition, finalPosition,
                radius);
    ...
    public void initialize(double previousVelocity, double nextVelocity) {
        ...
        axisStartDirections = MathCalc.makeG02AxisDirections(centerPosition,
                startPosition);
        double[] axisFinalDirections;
        axisFinalDirections = MathCalc.makeG02AxisDirections(centerPosition,
                finalPosition);
    ...
    private ArrayList<Point> incompletePath(double fullLength)
        ...
        if (startVelocity != finalVelocity) {
            ...
            time = Math.abs((2 * fullLength) / (Math.abs(startVelocity)
                    + Math.abs(finalVelocity)));
            ...
            this.acceleration = acceleration;
            return makeDynamicPath(startTime, startPosition, acceleration,
    ...
    private ArrayList<Point> makeStaticPath(double pathStartTime,
        ...
        double angleOfStaticPath = (MathCalc.findAngle(pathStartPosition,
                finalPosition, radius) - angleOfDeceleration);
