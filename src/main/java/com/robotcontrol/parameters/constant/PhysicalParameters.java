...
public class PhysicalParameters {
     ...
     */
    public final static double FIRST_LINK_DRAWING = 200;

    /**
     * Length of the second link for drawing.
     */
    public final static double SECOND_LINK_DRAWING = 200;

    /**
     * Length of the first ling for selecting, assembling, pick and place, etc.
     */
    public final static double FIRST_LINK_SELECTIVE = 200;

    /**
     * Length of the second ling for selecting, assembling, pick and place, etc.
     */
    public final static double SECOND_LINK_SELECTIVE = 200;
