...
public class Motion {
     ...
     */
    public final static double MAX_ACCELERATION = 2;
    ...
    public final static double[] NORMAL_ANG_VELOCITIES = {0.5, 1, 10};

    public final static double[] MAX_ANG_VELOCITIES = {2, 2, 12};

    public final static double[] NORMAL_ANG_ACCELERATIONS = {1, 2, 15};
